...
<img src="../main-screens/image-1.png" width="200" alt="Build InventoryButton Location"/>
...
<img src="../images/home/pauseoutfeed5.png" width="200" alt="Pause Outfeed Button Location"/>

- Click the **Pause Outfeed** button to pause outgoing cases
- Cases will stop and wait on the last position of InnoPick

<img src="../images/home/pauseoutfeed6.png" width="300" alt="Pause Outfeed Button Location"/>
...
<img src="../images/home/rdy2transfer6.png" width="600" alt="Infeed Statuses"/>

#### Waiting replenishment

<img src="../images/home/waitingreplen5.png" width="280" alt="Waiting Replenishment"/>
...
<img src="../images/home/waitingreplen6.png" width="500" alt="Waiting Replenishment"/>
...
#### Spiral A / B / C
- If InnoPick calculates that a certain destination (Spiral A, B, or C) cannot receive any more cases, it will stop scheduling output cases for that destination and indicate this with an **X** on the given level and over the given destination.
...
<img src="../images/home/hoverinfo.png" width="450" alt="Case Hover Detail"/>
...
<img src="../images/home/hoverinfo3.png" width="500" alt="Replenishment Link"/>
...
You can also click on "Recovery Actions" where you will see "Skip one retry if movement will not complete"

<img src="../images/home/hoverinfo6.png" width="700" alt="Hover Recovery Action"/>

This recovery action can be used if the storing or dispensing move for this case has failed, and for some mechanical reason, cannot be completed. 

- Using this action will tell InnoPick that the action has been completed, even though it has not. 
- This allows an operator to manually place the case where needed and resume production without having to fix the mechanical issue at that moment.
...
- **View in Case Sequence**: This will redirect the user to the Case Sequece page in InnoPick Manager, with a filter applied so only this case appears.
  - Tip: Right-click and "Open in New Tab" to keep this page open. You may need to login again in the new tab.
- **Recovery Actions**: This will show the same "Skip one retry if movement will not complete" option as for inbound cases. See the above explanation for details.
<hr style={{border: "none", height: "3px", backgroundColor: "#747474", margin: "2em 0"}} />
