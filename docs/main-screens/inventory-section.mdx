...
The Accumulations page displays values related to InnoPick's management of the space between InnoPick's exit and the downstream Spiral point (Spirals or equivalent).
...
- Cases exiting the downstream Spiral point (Spirals)
