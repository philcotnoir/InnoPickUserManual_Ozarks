...
#### Destination (Spiral) A or B Enabled / Disabled
- Controls which downstream destinations are active
- If a Spiral is disabled, all cases route to other destination(s)
- Check: [Administration > Setup InnoPick > Spirals](../main-screens/administration/setup-innopick.md#buffer)
