# Logging In to InnoPick Manager
...
Depending on your assigned user role, some menu options may not be accessible. See [User Roles](../main-screens/administration/user-manager.md#user-roles) for the full list of roles and their permissions.
