...
Based on your user role, you may see some menu options grayed out or missing entirely. See [User Roles](../main-screens/administration/user-manager.md#user-roles) for the full list of roles and their permissions.
